...
Check out the [examples](https://github.com/ivanZanardi/pyharm/tree/main/examples) provided in the repository to see PyHarm in action. Please see the [documentation]([https://github.com/ivanZanardi/pyharm/tree/main/examples](https://pyharmspline.readthedocs.io/en/latest/index.html)) website for a detailed user guide on PyHarm.
